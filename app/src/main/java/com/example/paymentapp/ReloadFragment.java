...
public class ReloadFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Set a click listener on the back button to navigate back to HomeFragment
        backButton.setOnClickListener(v -> {
            // Navigate back to the previous fragment
            getParentFragmentManager().popBackStack(); // This will pop ReloadFragment from the back stack
        });
